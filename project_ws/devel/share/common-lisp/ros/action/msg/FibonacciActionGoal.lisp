...
(cl:defclass <FibonacciActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type action-msg:FibonacciGoal
    :initform (cl:make-instance 'action-msg:FibonacciGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name action-msg:<FibonacciActionGoal> is deprecated: use action-msg:FibonacciActionGoal instead.")))
